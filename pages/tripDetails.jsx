    ...
    return (
        <div>
            <div
                ...
                style={{ backgroundImage: `url(${trip_details_bg})` }}
            >
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className={styles.happy_travling}>
                                <div>
                                    <p className={styles.happy_travel_p1}>
                                        Happy <br /> Travelling!
                                    </p>
                                </div>
                                <p className={styles.happy_travel_p2}>
                                    We’ll get back to you in few hours!
                                </p>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className={styles.main_back_btn11}>
                                <div id={styles.main_card_div}>
                                    <div className="container">
                                        ...
                                        <TripDetailsProps
                                            name={`+91 ${userDetails.mobile}`}
                                            userName="Mobile Number"
                                        />
                                        <TripDetailsProps
                                            name={destinationPlace.destination}
                                            userName="Destination"
                                        />
                                        <TripDetailsProps
                                            name={destinationPlace.guests}
                                            userName="No of Guests"
                                        />
                                        <TripDetailsProps
                                            name={userInterest.user_interest?.join(",")}
                                            userName="Interest"
                                        />
                                        <TripDetailsProps
                                            name={`₹ ${userInterest.budget}`}
                                            userName="Budget per person"
                                        />
                                        <TripDetailsProps
                                            name={`${destinationPlace.startdate}, ${destinationPlace.enddate}`}
                                            userName="Start & End Date"
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <Link href="/">
                                <button
                                    ...
                                    id={styles.back_home_btn}
                                >
                                    <i className="fa fa-long-arrow-left"></i>
                                    <span className={styles.back_btn11}>Back To Home</span>
                                </button>
                            </Link>
                        </div>
                    </div>
