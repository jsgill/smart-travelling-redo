                    ...
                    <div className="col-md-7">
                        <div className={styles.home_carousal_card}>
                            <div className={styles.bca}>
                                <TripInput inputValue={inputVal.length == 0 ? "Choose Interest" : inputVal} changeHandler={() => (null)} max="false" className={styles.input_field} clickHandler={toggleInput1} readonly="readonly" />
                                ...
                                <TripInput inputValue={amount.length === 0 ? "Budget Per Person" : amount} changeHandler={demo} max="false" className={styles.input_field} clickHandler={toggleInput2} readonly="readonly" />
